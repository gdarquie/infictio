...
<?php include("editeur/php/interfaceEn.php"); ?>
...
<section class='container' id='page'>
	...
	<div class='col-md-9 col-xs-12 tlt' id='titreAccueil'>
		...
		<a  href='#' onclick='lireLettre("_intro1", "_lettre", "_lettre2", "_lettre3", "intro()" );'><h1>dis(re)pair</h1></a>	
		<div id='genre' class="cache">
			<p id='soustitre'>Interactive story</p>
		</div>
		<div id='auteurs' class="cache"><div>Agathe Raymond-Carlo</div><div>Gaétan Darquié</div></div>
...
<footer class='cache'>
		<p>dis(re)pair &copy; 2014 | V0.8 démo 03/05/14 | musique <span id='musicOnOff' onclick='stoplamousique();' class='slien'>on</span> | <a href='index.php' class='slien' id="langue">français</a> | <a href='english.php' class="slien">accueil</a> | <span class='slien' onclick='chapitre("_chapitre");whiteMe();'>chap1</span> | <span class='slien' onclick='chapitre("_chapitre2");changeMusic(_musique2);whiteMe();'>chap2</span> | <span class='slien' onclick='chapitre("_chapitre3");whiteMe();'>chap3</span> | <span class='slien' onclick='chapitre("_chapitre4");whiteMe();'>chap4</span> | <span class='slien' onclick='chap4Out();chapitre("_ccl");changeMusic(_musique3);whiteMe();'>ccl</span></p>
